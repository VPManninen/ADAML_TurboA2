...
for dataset = 1:4
    ...
    axis tight
    title("Dataset " + dataset + " (high RULs removed), remaining variables")
...
for dataset = 1:4
  ...
  sgtitle("Dataset " + dataset + " (high RULs removed), true Y vs. predicted Y")
end
